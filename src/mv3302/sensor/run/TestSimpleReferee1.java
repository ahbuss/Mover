 ...
 * @author ahbuss
 */
public class TestSimpleReferee1 {
    ...
    public static void main(String[] args) {
        ...
        Point2D[] path1 = new Point2D[] {
            ...
            new Point2D.Double(40.0, 500.0)
        };
        SimplePathMoverManager moverManager1 = 
                new SimplePathMoverManager(movers[0], Arrays.asList(path1), true);
        ...
        SimplePatrolMoverManager moverManager2 = 
                new SimplePatrolMoverManager(movers[1], Arrays.asList(path2), false);
